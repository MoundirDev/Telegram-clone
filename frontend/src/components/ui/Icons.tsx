...
export function IconAttach({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function IconSmile({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function IconTelegram({ className = 'w-16 h-16' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 240 240" fill="none">
      <circle cx="120" cy="120" r="120" fill="url(#tg-grad)" />
      <path
        d="M81 121l38 14 49-47-61 38-38-14 12 9z"
        fill="#fff"
        opacity=".9"
      />
      <path d="M98 135l-5 28 9-16 16-12-20-20z" fill="#D2E5F1" />
      <defs>
        <linearGradient id="tg-grad" x1="0" y1="0" x2="240" y2="240">
